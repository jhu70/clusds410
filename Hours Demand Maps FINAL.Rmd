...
leaflet(hours_demand) %>%
  ...
  addLegend("topleft", 
              ...
              opacity = 1,
              title = "Percentage of people that leave to work in the early morning")
```
...
leaflet(hours_demand) %>%
  ...
  addLegend("topleft", 
              ...
              opacity = 1,
            title = "Percentage of people that leave to work in the evening")
```
...
leaflet(hours_demand) %>%
  ...
  addLegend("topleft", 
              ...
              opacity = 1,
              title = "Percentage of people that leave to work overnight")
```
