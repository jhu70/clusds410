...
hours_demand <- hours_demand %>%
  ...
  #taking out weird tract
  filter(NAME.x!="Census Tract 9901.01, Suffolk County, Massachusetts")
```
...
leaflet(hours_demand) %>%
  ...
  addLegend("topleft", 
              ...
              opacity = 1,
              title="Early Morning Percentage")
```
...
leaflet(hours_demand) %>%
  ...
  addLegend("topleft", 
              ...
              opacity = 1,
              title="Late evening/overnight percentage")
```
