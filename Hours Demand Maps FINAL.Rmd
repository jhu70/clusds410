...
#Early morning
```{r}
pal <- colorBin("YlOrRd", domain = hours_demand$percent_early)
...
#Evening
```{r}
pal <- colorBin("YlOrRd", domain = hours_demand$percent_evening)
leaflet(hours_demand) %>%
  addProviderTiles("CartoDB")  %>%
...
#Overnight
```{r}
pal <- colorBin("YlOrRd", domain = hours_demand$percent_overnight)
leaflet(hours_demand) %>%
  addProviderTiles("CartoDB")  %>%
