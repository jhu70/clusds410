...
First the census data leads to a deviation from real life situations. The census data assumes people work for the same amount of hours everyday while 
-general lack of ability to merge census data and EEC: comparing different variables for the same construct
-Lack of data in EEC about important variables like rates and subsidY
-Specific info on each providers, e.g., capacity of each provider by age groups
