...
![Demand: Number of Children Under 6 with Parents in the Labor Force](fig1.png){width=500}


![Demand: Number of Children Under 6 with Parents in the Labor Force](fig1.png){width=500}

![Number of slots available for early ed by tracts](Fig 2, slots.png){width=500}

![Gap between supply and demand of capacities](Fig 3, ratioslots.png){width=500}

![Demand: Percentage maps by tracts on people departure time for work in the morning](fig4.png){width=500}

![Demand: Percentage maps by tracts on people departure time for home in the evening](fig5.png)

![Demand: Percentage maps by tracts of people whose departure time for home is overnight](fig6.png)

![Supply: Number of slots in certain tracts by providers who operate off hour during weekdays for early ed.](fig7.png)
