...
```{r, message = FALSE, out.width='25%', fig.align='center', fig.cap='Table1', include = FALSE,include = TRUE, echo = FALSE}
...
```{r, out.width='25%', fig.align='center', fig.cap='Table2', include = FALSE,include = TRUE, echo = FALSE}
...
knitr::include_graphics('fig3]ng')
```
