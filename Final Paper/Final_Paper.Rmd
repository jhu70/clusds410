...
stargazer(tract_neighborho[c("Capacity","Capacity_by_neighborho","Capacity_by_tract")], type = "text", title="Descriptive table(early ed only)", digits=0,summary.stat = c("mean", "sd","min","max"), covariate.labels = c("Average number of slots by providers (slot)", "Average number of slots by neighborhood(slot)", "Average number of slots by tract(slot)"))
```



The table in Figure 1 presents the summary statistics on the distribution of the capacities of all providers and capacities available in neighborhoods and tracts. The mean capacity of providers is 24.7, of all neighborhoods in Boston is 1469, and of tracts in Boston is 169.2.

```{r, warning = FALSE, out.width='25%', fig.align='center', fig.cap='Table2', include = FALSE,include = TRUE, echo = FALSE}
stargazer(tract_neighborho_off[c("Capacity_off","Capacity_neighborho_off","Capacity_tract_off")], type = "text", title="Descriptive table(weekdays off hour services for early ed)", digits=0,summary.stat = c("mean", "sd","min","max"),covariate.labels = c("Average number of off-hour slots by providers", "Average number of off-hour slots by neighborhood", "Average number of off-hour slots by tract"))
```
...
```{r, out.width='100%', fig.align='center', fig.cap='Figure3: Gap between supply and demand of capacities', include = FALSE,include = TRUE, echo = FALSE}
knitr::include_graphics('fig3.png')
```

```{r, message = FALSE, warning = FALSE, out.width='25%', fig.align='center', fig.cap='Ratio of slots to children', include = FALSE,include = TRUE, echo = FALSE}
...
```{r, out.width='25%', fig.align='center', fig.cap='Figure4: Percentage maps by tracts on people departure time for work in the morning', include = TRUE, echo = FALSE}
...
```{r, out.width='25%', fig.align='center', fig.cap='Figure5: Percentage maps by tracts on people departure time for home in the evening',include = TRUE, echo = FALSE}
...
```{r, out.width='25%', fig.align='center', fig.cap='Percentage maps by tracts of people whose departure time for home is overnight', include = TRUE, echo = FALSE}
