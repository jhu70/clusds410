...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include_graphics}\NormalTok{(}\StringTok{'fig5.png'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include_graphics}\NormalTok{(}\StringTok{'fig6.png'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\caption{Figure6: Percentage maps by tracts of people whose departure time for home is overnight}\label{fig:unnamed-chunk-8}
\end{figure}
...
\caption{Figure7: Number of slots in certain tracts by providers who operate off hour during weekdays for early ed}\label{fig:unnamed-chunk-9}
\end{figure}
