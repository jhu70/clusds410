...
```{r}
stargazer(tract_neighborho[c("Capacity","Capacity_by_neighborho","Capacity_by_tract")], type = "html", title="Table1: Descriptive table(early ed only)", digits=0, out="des_capacity.html",summary.stat = c("mean", "sd","min","max"))

stargazer(tract_neighborho_off[c("Capacity_off","Capacity_neighborho_off","Capacity_tract_off")], type = "html", title="Table2: Descriptive table(weekdays off hour services for early ed)", digits=0, out="des_capacity_off.html",summary.stat = c("mean", "sd","min","max"))
```
