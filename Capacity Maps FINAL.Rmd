...
```{r}
pal_ratioslots <- colorBin("Reds", domain = EEC_census$ratioslots)
leaflet(EEC_census) %>%
  addProviderTiles("CartoDB")  %>%
...
ggplot(EEC_census_bar,aes(x =reorder(Name_neighborho,-ratioslots), y = ratioslots, fill = Name_neighborho)) +
  geom_bar(colour="black", stat="identity") + ggtitle( "Neighborhood ranking by desert ratio")+ xlab("Neighborhoods")+  ylab("Desert Ratio (Population under 6/Capacity for early ed")
```
...
ggplot(EEC_census_bar5,aes(x =reorder(Name_neighborho,-ratioslots), y = ratioslots, fill = Name_neighborho)) +
  geom_bar(colour="black", stat="identity") + ggtitle( "Top 5 Neighborhood ranking with the highest desert ratio")+ xlab("Neighborhoods")+  ylab("Desert Ratio (Population under 6/Capacity for early ed")
```
