...
```{r, out.width='25%', fig.align='center', fig.cap='Table1', include = FALSE}
...
```{r, out.width='25%', fig.align='center', fig.cap='Table2', include = FALSE}
...
```{r, out.width='25%', fig.align='center', fig.cap='Figure1: Number of children under 6 from working families', include = FALSE}
...
```{r, out.width='25%', fig.align='center', fig.cap='Figure2: Number of slots available for early ed by tracts', include = FALSE}
...
```{r, out.width='100%', fig.align='center', fig.cap='Figure3: Gap between supply and demand of capacities', include = FALSE}
...
```{r, out.width='25%', fig.align='center', fig.cap='Figure4: Percentage maps by tracts on people departure time for work in the morning', include = FALSE}
...
```{r, out.width='25%', fig.align='center', fig.cap='Figure5: Percentage maps by tracts on people departure time for home in the evening'}
...
```{r, out.width='25%', fig.align='center', fig.cap='Figure6: Percentage maps by tracts of people whose departure time for home is overnight'}
...
```{r, out.width='25%', fig.align='center', fig.cap='Figure7: Number of slots in certain tracts by providers who operate off hour during weekdays for early ed', include = FALSE}
