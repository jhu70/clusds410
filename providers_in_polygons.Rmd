...
census_tract$ALAND<-as.factor(census_tract$ALAND)
census_tract$AWATER<-as.factor(census_tract$AWATER)
#add back geometry
classification2<-left_join(classification,census_tract, on = "GEOID")
...
#exclude geometry since it messes the data set
...
tractneighborho<-masterdataframe_tract_neighborho_g%>%
